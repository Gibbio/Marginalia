"""Composition root for the headless Marginalia backend."""
...
class BackendContainer:
    """Runtime object graph for backend and frontend clients."""
...
def build_backend_container(
    ...
    *,
    ...
    """Construct the service graph for a backend process."""
